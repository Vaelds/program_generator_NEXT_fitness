/* QRCode for JavaScript, Copyright (c) 2009 Kazuhiko Arase, MIT. Bundled locally for offline use. */
(function(){
const modules={'QR8bitByte':function(require,module,exports){
...
const cache={};function require(name){name=name.replace(/^.\//, "");if(cache[name])return cache[name].exports;const module={exports:{}};cache[name]=module;modules[name](require,module,module.exports);return module.exports;}
window.NextQR=require("index");
})();
